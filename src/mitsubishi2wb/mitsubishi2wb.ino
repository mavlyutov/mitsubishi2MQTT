...
void mqttCallback(char* topic, byte* payload, unsigned int length) {
  ...
  if (strcmp(topic, power_set_topic.c_str()) == 0) {
    if (message == "0") { rootInfo["power"] = "OFF"; }
    else if (message == "1") { rootInfo["power"] = "ON"; }
    else { return; }
    ...
    hp.update();
      ...
      if (message == "0") { rootInfo["mode"] = "AUTO"; }
      else if (message == "1") { rootInfo["mode"] = "DRY"; }
      else if (message == "2") { rootInfo["mode"] = "COOL"; }
      else if (message == "3") { rootInfo["mode"] = "HEAT"; }
      else if (message == "4") { rootInfo["mode"] = "FAN"; }
      else { return; }
      ...
      if (message == "0") { rootInfo["fan"] = "AUTO"; }
      else if (message == "1") { rootInfo["fan"] = "QUIET"; }
      else if (message == "2") { rootInfo["fan"] = "1"; }
      else if (message == "3") { rootInfo["fan"] = "2"; }
      else if (message == "4") { rootInfo["fan"] = "3"; }
      else if (message == "5") { rootInfo["fan"] = "4"; }
      else { return; }
      hp.setFanSpeed(rootInfo["fan"]);
      hp.update();
  } else if (strcmp(topic, vane_set_topic.c_str()) == 0) {
      if (message == "0") { rootInfo["vane"] = "AUTO"; }
      else if (message == "1") { rootInfo["vane"] = "SWING"; }
      else if (message == "2") { rootInfo["vane"] = "1"; }
      else if (message == "3") { rootInfo["vane"] = "2"; }
      else if (message == "4") { rootInfo["vane"] = "3"; }
      else if (message == "5") { rootInfo["vane"] = "4"; }
      else if (message == "6") { rootInfo["vane"] = "5"; }
      else { return; }
      hp.setVaneSetting(rootInfo["vane"]);
      hp.update();
  } else if (strcmp(topic, widevane_set_topic.c_str()) == 0) {
      if (message == "0") { rootInfo["wideVane"] = "SWING"; }
      else if (message == "1") { rootInfo["wideVane"] = "<<"; }
      else if (message == "2") { rootInfo["wideVane"] = "<"; }
      else if (message == "3") { rootInfo["wideVane"] = "|"; }
      else if (message == "4") { rootInfo["wideVane"] = ">"; }
      else if (message == "5") { rootInfo["wideVane"] = ">>"; }
      else if (message == "6") { rootInfo["wideVane"] = "<>"; }
      else { return; }
